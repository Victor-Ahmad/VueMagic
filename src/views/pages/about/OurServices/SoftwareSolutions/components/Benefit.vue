        ...
        <b-col lg="6" class="mb-6 mb-lg-0">
          <b-card no-body class="bg-dark overflow-hidden p-sm-4 h-100" data-bs-theme="dark">
            <b-card-header class="bg-transparent position-relative mb-3">
              ...
              <p>Our Software Solutions service is ideal for:</p>
...
import { testimonials } from '@/views/pages/about/OurServices/SoftwareSolutions/data'
import SwiperCard from '@/views/pages/about/OurServices/SoftwareSolutions/components/SwiperCard.vue'
import { approach } from '@/views/pages/about/OurServices/SoftwareSolutions/data'
