    ...
    <b-container>
      <b-row>
        <b-col lg="6" class="mb-6 mb-lg-0">
          <b-card no-body class="bg-dark overflow-hidden p-sm-4 h-100" data-bs-theme="dark">
            <b-card-header class="bg-transparent position-relative mb-3">
              ...
              <p>Our Outsourcing service is ideal for businesses of all sizes that want to:</p>
        ...
        <b-col lg="6" class="mb-6 mb-lg-0">
          <b-card no-body class="bg-dark overflow-hidden p-sm-4 h-100" data-bs-theme="dark">
            <b-card-header class="bg-transparent position-relative mb-3">
              <h3 class="mb-6">Roles We Provide:</h3>

              <b-list-group
                class="list-group-borderless border-0 card-body bg-light border p-md-5 h-100"
              >
                <b-list-group-item
                  v-for="role in roles"
                  :key="role"
      ...
      <b-row class="mt-4">
        <b-col lg="12" class="ms-auto">
          <h2>Feedback for Service Enhancement</h2>
          <p class="lead mb-2">
            300+ Users rated us <span class="text-primary fw-bold">4.85</span> out of 5.
          </p>
...
import { testimonials } from '@/views/pages/about/OurServices/Outsourcing/data'
import SwiperCard from '@/views/pages/about/OurServices/Outsourcing/components/SwiperCard.vue'
import { approach } from '@/views/pages/about/OurServices/Outsourcing/data'
import { roles } from '@/views/pages/about/OurServices/Outsourcing/data'
