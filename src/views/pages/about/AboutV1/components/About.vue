    ...
    <b-container>
      <b-row class="g-4 align-items-center">
        ...
        <b-col lg="6" class="ps-md-5">
          ...
          <p class="mb-0">
            Elevate your online presence and embark on a journey to digital excellence with our
            meticulously designed digital agency theme.
          </p>

          <hr class="my-4" />
          <p>
            At the heart of our theme is a commitment to providing a robust and versatile platform
            that accommodates the diverse needs of digital agencies.
          </p>
