...
import type { StatisticType, FeatureType, FeaturesType,TestimonialType } from '@/types'
...
export const counter: StatisticType[] = [
  ...
  },
  {
    ...
    number: 200,
    prefix: '+',
    description: 'Acquired Users'
  },
  {
    title: 'Positive User Reviews',
    number: 10,
    prefix: 'K+',
    description: 'Positive User Reviews'
  },
  {
...
export const features: FeatureType[] = [
  {
    ...
    description:
      'You reach out to us with your needs and objectives. Whether through our website, email, or phone, we’re ready to listen and understand your requirements.'
  },
  {
    ...
    description:
      'We conduct a detailed analysis to assess your current situation and identify opportunities. Our team then provides a comprehensive overview of potential solutions, along with associated costs.'
  },
  {
    ...
    description:
      'Once we receive your approval, we prepare a detailed plan that outlines the solution, timelines, and any necessary resources. This plan is designed to meet your specific goals and constraints.'
  },
...
export const feature: FeaturesType[] = [

  {
    ...
    description:
      'We finalize the agreement and contract, ensuring that all aspects of the project are clearly defined and agreed upon.'
  },
  {
    icon: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">\n<path d="M3.40004 19.9484C3.41524 20.1895 3.42283 20.3101 3.51172 20.4292C3.53619 20.462 3.58073 20.5066 3.61353 20.5311C3.73269 20.6199 3.85325 20.6275 4.09437 20.6427C5.14741 20.7091 7.28849 20.6474 8.66268 19.2732C9.39454 18.5414 9.77757 17.5685 9.97243 16.6532C10.0108 16.4728 10.03 16.3826 10.0112 16.2835C10.0053 16.2528 9.99478 16.2173 9.98295 16.1883C9.94486 16.0949 9.87386 16.0239 9.73186 15.8819L8.16087 14.3109C8.01887 14.1689 7.94787 14.0979 7.85449 14.0598C7.82551 14.048 7.78998 14.0375 7.75923 14.0316C7.66016 14.0127 7.56997 14.0319 7.38958 14.0703C6.47423 14.2652 5.50139 14.6482 4.76953 15.3801C3.39534 16.7543 3.33368 18.8954 3.40004 19.9484Z" fill="currentColor" />\n<path fill-rule="evenodd" clip-rule="evenodd" d="M7.02164 6.44822C5.26483 6.54451 3.88965 7.99713 3.88965 9.75657C3.88965 11.5264 5.28055 12.9837 7.04843 13.0663L7.85685 13.104C7.90862 13.1064 7.95762 13.1281 7.99427 13.1647L10.8462 16.0167C10.8829 16.0533 10.9045 16.1023 10.9069 16.1541L10.9447 16.9625C11.0272 18.7304 12.4846 20.1213 14.2544 20.1213C16.0138 20.1213 17.4665 18.7461 17.5627 16.9893L17.7857 12.9211C20.8652 9.28048 20.5871 5.1321 20.4317 3.95598C20.4053 3.75678 20.2527 3.60577 20.0532 3.58128C18.883 3.43754 14.774 3.19885 11.0864 6.22543L7.02164 6.44822ZM14.8799 11.3516C14.8799 12.5942 13.8725 13.6016 12.6299 13.6016C11.3872 13.6016 10.3799 12.5942 10.3799 11.3516C10.3799 10.1089 11.3872 9.10156 12.6299 9.10156C13.8725 9.10156 14.8799 10.1089 14.8799 11.3516Z" fill="currentColor" fill-opacity="0.25" />\n</svg>',
    title: 'Execution & Delivery:',
    description:
      'Our team begins executing the plan, keeping you updated on progress and making adjustments as needed. We’re committed to delivering results that exceed expectations.'
  },
...
export const testimonials: TestimonialType[] = [
  {
    comment:
      'Working with InnovaCraft was a game-changer for us. Their ability to understand our needs and deliver a tailored solution was impressive. We saw immediate improvements in our operations and a significant boost in our market presence.',
    user: {
      avatar: avatar4,
      username: 'Dennis Barrett',
      role: 'Jessica Taylor, Product Manager '
    }
  },
  {
    comment:
      'The team at [Your Company Name] provided invaluable insights and a strategic approach that helped us navigate complex business challenges. Their professionalism and expertise have been instrumental in our success.',
    user: {
      avatar: avatar5,
      username: 'Samuel Bishop',
      role: 'Michael Anderson, CEO '
    }
  },
